...
# ╔═╡ a7f739c9-85b0-4dd2-82cc-a0f4daebdc9b
using PlutoUI, Plots, ColorSchemes, Images, Interpolations

# ╔═╡ 90eccfd9-346a-4455-82ef-57993e49259a
input = split("4567894301299921298789654345689439843295436789543298765432345678986789756901239998765634567895986555
...
# ╔═╡ 5d48a7c8-c1eb-4770-98a3-0a71ffea9338
begin
	...
	for y = 1:height
	    for x = 1:width
	        grid[y,x] = parse(Int, input[y][x]);
	    end
	end
end;

# ╔═╡ f91792c4-1352-426e-b3fb-e8decbeeeb3d
begin
	@bind colorscheme_name HTML() do io
		println(io, "Select colorscheme: ")
		println(io, "<select>")
		for c in keys(colorschemes)
			println(io, "<option value=\"$c\">$c</option>")
		end
		println(io, "</select>")
	end
end

# ╔═╡ 0122af20-5969-11ec-1ea8-1fa27d2a9d82
# Using Plots package
heatmap(1:width, 1:height, grid, c = Symbol(colorscheme_name))

# ╔═╡ 36f1623e-93fa-4b36-9322-152daa6dbff6
# Using Images package
begin
	scalefactor = 3
	biggrid = zeros(Int, height * scalefactor, width * scalefactor)
	for y = 1:height * scalefactor
		for x = 1:width * scalefactor
			biggrid[y,x] = grid[fld1(y, scalefactor), fld1(x, scalefactor)]
		end
	end
	isnot9 = biggrid .!= 9
	r = isnot9 .* (1 .- biggrid ./ 18 .+ 0.5)
	g = isnot9 .* (1 .- biggrid ./ 9)
	b = isnot9
	RGB.(r, g, b)
end
